...
import { Gui2DManager } from './Gui2DManager.js';
import { Gui3DManager } from './Gui3DManager.js';
import {remap, lerp, hexToRgb, calculateScale, map, getColor, showAxis, colorList, months} from './utilities.js';
...
class ChartSceneManager {
    ...
    initializeScene() {
        ...
        let light5 = new BABYLON.PointLight("light2", new BABYLON.Vector3(0, 0, 0), scene);
        light5.intensity = .8;
...
class BarChart extends BaseChart {
    ...
    build(barChartOptionsxx) {
        ...
        // this.gui3D.create3dLegend(this.scene, this.myBars, this.options);
